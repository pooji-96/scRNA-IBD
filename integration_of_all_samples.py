...
import tarfile
with tarfile.open("GSE167377_RAW.tar", "r") as tar:
    tar.extractall() # Extract all files into current directory
...
# Violin plot
sc.pl.violin(adata, ['n_genes_by_counts', 'total_counts', 'pct_counts_mt'], jitter=0.4, multi_panel=True, show=False, save="qc_violin.png")

sc.pl.scatter(adata, x='total_counts', y='pct_counts_mt', show=False, save="total_vs_mt.png")
sc.pl.scatter(adata, x='total_counts', y='n_genes_by_counts', show=False, save="total_vs_genes.png")
...
# Plotting PCA
sc.pl.pca_variance_ratio(adata, log=True, show=False, save="pca.png")
...
sc.pl.umap(adata, color = ['leiden', 'Sample'], legend_loc='on data', show=False, save="umap_leiden_sample_0.25.png")
...
# Highly variable genes
sc.pp.highly_variable_genes(adata, min_mean=0.0125, max_mean=3, min_disp=0.5)
sc.pl.highly_variable_genes(adata, show=False, save="highly_variable_genes_reloaded.png")
...
sc.tl.pca(adata, svd_solver='arpack')
# Plotting PCA
sc.pl.pca_variance_ratio(adata, log=True, show=False, save="pca_reloaded.png")
...
sc.pl.umap(adata, color = ['leiden', 'Sample'], show=False, save="umap_integrated.png")

sc.pl.umap(adata, color = ['leiden', 'Sample'], legend_loc='on data', show=False, save="umap_integrated_legend.png")
...
sc.pl.rank_genes_groups(adata, n_genes=20, sharey=False, show=False, save="rank_genes_groups.png")
...
sc.pl.umap(adata, color = ['Cell Type'], frameon=False, show=False, save="umap_celltype.png")
...
sc.pl.umap(adata, color = ['Condition'], frameon=False, show=False, save="umap_condition.png")

control = ["Control"]
adata1 = adata[adata.obs.Condition.isin(control)]

sc.pl.umap(adata1, color = ['Condition'], frameon=False, show=False, save="umap_control.png")

sc.pl.umap(adata1, color = ['Cell Type'], frameon=False, show=False, save="umap_control_celltype.png")

control = ["Infected"]
adata2 = adata[adata.obs.Condition.isin(control)]

sc.pl.umap(adata2, color = ['Condition'], frameon=False, show=False, save="umap_infected.png")

sc.pl.umap(adata2, color = ['Cell Type'], frameon=False, show=False, save="umap_infected_celltype.png")
